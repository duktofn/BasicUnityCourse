# Khóa Học Unity Cơ Bản (Basic Unity Course)

Chào mừng bạn đến với tài liệu học tập của khóa học **Unity Cơ bản**! Repository này chứa toàn bộ giáo trình, đề cương, và tài liệu hướng dẫn chi tiết theo từng buổi học để giúp bạn xây dựng trò chơi đầu tiên của mình từ đầu.

---

## 📌 Thông tin chung
* **Phiên bản Unity sử dụng:** Unity 6000.3.18f1 (Unity 6.3 LTS)
* **Hình thức học:** Online qua Discord
* **Mục tiêu:** Sau 10 buổi học (khoảng 1 tháng), học viên nắm vững kiến thức cơ bản về Unity Engine và hoàn thiện một dự án game nhỏ tự tay thiết kế.
...
3. 💻 **[Session 2 - First Script, MonoBehaviour, New Input System](file:///d:/BasicUnity/Session 2 - First Script, MonoBehaviour, New Input System.md)**:
   ...
   * Đọc dữ liệu nhập từ bàn phím bằng **New Input System** (Input Actions).

---

## ⚙️ Yêu cầu cài đặt trước khi bắt đầu
Để thực hành theo tài liệu, vui lòng chuẩn bị:
1. **Unity Hub** & **Unity Editor 6000.3.18f1**.
2. **Code Editor:** VS Code hoặc JetBrains Rider.
3. **Git** & tài khoản **GitHub**.
4. **Tài khoản Unity ID** (để kích hoạt license cá nhân miễn phí).
